...
####
dat1 = fread("ANM1_corrected.txt", header = T, stringsAsFactors = F)
...
dat1_demographic_matrix <- model.matrix( ~ anm1$Dx + anm1$age + anm1$sex)
...
write.table(deg_cv1, "DEG_ANM1.txt", row.names = F, col.names = T, sep = "\t")
